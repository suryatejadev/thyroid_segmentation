...
definitions = [
    ...
    ('model',            (str,   'unet', "Model: unet, dilated-unet, dilated-densenet, window-unet, masktrack-unet")),
    ...
    ('learning-rate',    (float, 1e-5,   "Optimizer learning rate.")),
    ...
    ('train_steps_per_epoch',  (int,   20,     "Number of train steps in one epoch.")),
    ('val_steps_per_epoch',    (int,   8,     "Number of validation steps in one epoch.")),

    # files
    ('datadir',          (str,   '../data/',    "Directory containing patientXX/ directories.")),
    ('outdir',           (str,   '../output/',    "Directory to write output data.")),
    ...
    ('ckpt_period',      (int,  10,     "Period of epochs after which weights are saved")),

    # augmentation
    ('data-augment', {'default': False, 'action': 'store_true',
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Train U-Net to segment thyroid nodules from ultrasound images")
